# Запишите станции в порядке вывода через запятую и пробел (в именительном падеже с заглавной буквы), если нужно найти
# кратчайший путь от Адмиралтейской до Владимирской.
